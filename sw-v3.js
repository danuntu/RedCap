...
const CACHE='redcap-v4';
const ASSETS=['./','./index.html','./css/styles.css','./js/app-v4.js','./manifest.webmanifest','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/icons/favicon.ico'];
